...
4. Run the DesignSoul static audit (references/code-audit.md) after edits — `broken-ref`, `contrast-ratio`, and `orphaned-tokens` warnings flag issues automatically.
